...
import com.itachi1706.cheesecakeutilities.DataUsageActivity;
    ...
    public class MainMenuHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        public void onClick(View v) {
            switch (title.getText().toString()) {
                ...
                case "DataUsageBETA": mActivity.startActivity(new Intent(mActivity, DataUsageActivity.class)); break;
